...
$sql = "SELECT h.id,hmi.main_image, h.developer, h.property_name, h.locations, h.units, h.price, h.reservationfee,
               ...
               WHERE h.main_image_id = hmi.image_id AND h.status ='rfo' ORDER BY h.id desc LIMIT $start_from, $record_per_page ";
...
$page_query =
  "SELECT h.id,hmi.main_image, h.developer, h.property_name, h.locations, h.units, h.price, h.reservationfee,
              h.status FROM commercials as h, commercials_main_image as hmi
              WHERE h.main_image_id = hmi.image_id AND h.status ='rfo' ORDER BY h.id desc ";
