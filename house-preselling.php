...
<!------------------END OF NAVBAR----------------------->
  <main id="main">
          ...
          <div class="sticky" style="position: sticky; position: -webkit-sticky; top:0; ">
            ...
            <div class="bg-light border-right" id="sidebar-wrapper">
              <div class="list-group list-group-flush">
                <a href="house-preselling.php" class="list-group-item list-group-item-action active" id="house">House &amp; Lot</a>
                ...
                <a href="memorial-preselling.php" class="list-group-item list-group-item-action " id="memorial">Memorial Park</a>
    ...
    <!-- ======= Property Grid ======= -->
      ...
      <div class="col-lg-9">
      <h3 class="text-center text-success" id="textChange">House &amp; Lot </h3>
      <hr>  
...
$(document).ready(function(){
    ...
    function load_data(page){
        $.ajax({
            url:"house-preselling-pagination.php",
            method:"POST",
            data:{page:page},
