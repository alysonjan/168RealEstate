    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="house-rfo.php">RFO</a>
          </li>
          <li class="nav-item">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="sticky" style="position: sticky; position: -webkit-sticky; top:0; ">
            <h3>Properties for RFO</h3>
            <hr>


            <div class="bg-light border-right" id="sidebar-wrapper">
              <div class="list-group list-group-flush">
                <a href="house-rfo.php" class="list-group-item list-group-item-action" id="house">House &amp; Lot</a>
                <a href="commercial-rfo.php" class="list-group-item list-group-item-action active " id="commercial">Commercial Property</a>
...
$(document).ready(function(){
    ...
    function load_data(page){
        $.ajax({
            url:"commercial-rfo-pagination.php",
            method:"POST",
            data:{page:page},
