...
$sql = "SELECT h.id,hmi.main_image, h.developer, h.property_name, h.locations, h.units, h.price, 
               h.reservationfee, h.status FROM houseandlot as h, houseandlot_main_image as hmi
