          ...
          <div class="sticky" style="position: sticky; position: -webkit-sticky; top:0; ">
            ...
            <div class="bg-light border-right" id="sidebar-wrapper">
              <div class="list-group list-group-flush">
                <a href="house-sale.php" class="list-group-item list-group-item-action " id="house">House &amp; Lot</a>
                <a href="condo-sale.php" class="list-group-item list-group-item-action " id="condominiums">Condominiums</a>
                <a href="commercial-sale.php" class="list-group-item list-group-item-action active " id="commercial">Commercial Property</a>
                <a href="lots-sale.php" class="list-group-item list-group-item-action  " id="lots">Lot Only</a>
                <a href="memorial-sale.php" class="list-group-item list-group-item-action " id="memorial">Memorial Park</a>
...
$(document).ready(function(){
    ...
    function load_data(page){
        $.ajax({
            url:"commercial-sale-pagination.php",
            method:"POST",
            data:{page:page},
