        ...
        <div class="row">
          ...
          if (isset($_POST['link_viewmore'])) {
            ...
            $query = "SELECT hi.images,h.developer,h.property_name,h.locations,h.units,h.squarefoot,
                      ...
                      h.monthlyprice,h.status,h.description FROM condominiums as h,condominiums_images as hi
                ...
                <div class="col-md-12 col-lg-4">
                  <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item">
                        <a href="condo-property-single.php">Properties</a>
                      </li>
                    </ol>
                  </nav>
                </div>
                        ...
                        <div class="carousel-inner">
                          ...
                          ?>
                            <div class="carousel-item <?= $actives; ?>">
                              <img src="/RealEstate/RealEstate/backend/condominiums/<?= $row['images']; ?>" width="100%" height="550" style="object-fit:cover";>
                            </div>
