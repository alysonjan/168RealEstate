...
<section class="contact">
      <div class="container">
          ...
          <h2 class="title-a text-center text-info">Contact Us!</h2>
          </div>
            <div class="row">
              <div class="col-md-7">
                <form method="post">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <input name="prefertime" class="form-control " placeholder="Preferred time to call"  data-msg="Please enter a time">
                        <div class="validate"></div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <textarea name="message" class="form-control" cols="45" rows="8" data-rule="required" data-msg="Please write something for us" placeholder="Message / Inquiries"></textarea>
                        <div class="validate"></div>
                      </div>
                    </div>

                    <div class="col-md-12 text-center mb-5">
                      <button type="submit" name="send" class="btn btn-a" style="border-radius: 30px;">Send Message</button>
                    </div>
                  </div>
                </form>
              </div>
