    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="house-preselling.php">Pre-selling</a>
          </li>
          <li class="nav-item">
...
<!------------------END OF NAVBAR----------------------->
  <main id="main">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="sticky" style="position: sticky; position: -webkit-sticky; top:0; ">
            <h3>Properties for Pre-Selling</h3>
            <hr>
           

            <div class="bg-light border-right" id="sidebar-wrapper">
              <div class="list-group list-group-flush">
                <a href="house-preselling.php" class="list-group-item list-group-item-action bg-light" id="house">House &amp; Lot</a>
                <a href="condo-preselling.php" class="list-group-item list-group-item-action bg-light " id="condominiums">Condominiums</a>
                <a href="commercial-preselling.php" class="list-group-item list-group-item-action bg-primary active " id="commercial">Commercial Property</a>
                <a href="lots-preselling.php" class="list-group-item list-group-item-action bg-light " id="lots">Lot Only</a>
                <a href="memorial-preselling.php" class="list-group-item list-group-item-action bg-light " id="memorial">Memorial Park</a>
    ...
    <!-- ======= Property Grid ======= -->
      ...
      <div class="col-lg-9">
      <h3 class="text-center text-success" id="textChange">Commercial Property </h3>
      <hr>  
...
$(document).ready(function(){
    ...
    function load_data(page){
        $.ajax({
            url:"commercial-preselling-pagination.php",
            method:"POST",
            data:{page:page},
