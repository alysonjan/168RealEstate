...
$query = "SELECT * FROM memorial ORDER BY id desc limit 1 ";
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    ...
                    <h1 class="Page-header ">Memorial Park</h1>

                    <div class="modal fade" id="memorialModal">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                    <h4 class="modal-title" id="myModalLabel">New Listing for Memorial Park</h4>
                                </div>

                                <!-- ##########################INSERT DATA################################### -->
                                <div class="modal-body">
                                    <form action="memorialbackend.php" method="POST" enctype="multipart/form-data">
                                    <div class="form-row">
                                        ...
                                        <div class="col text-center">
                                            ...
                                            <button type="submit" class="btn btn-success" id="memorial-save-btn" name="memorial-save-btn">Save</button>
                                        </div>
                                    </form>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <button class="btn btn-primary btn-lg fa fa-plus " data-toggle="modal" data-target="#memorialModal"> Add Property</button>
                                        <?php

                                        $query = "SELECT id,property_name,locations,price,status FROM memorial ORDER BY id desc";
     ...
     <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.deletebutton', function() {
                var memorial_delete_property_id = $(this).attr("id");
                $.ajax({
                    url: "memorialbackend.php",
                    method: "POST",
                    data: {
                        memorial_delete_property_id: memorial_delete_property_id
                    },
                    success: function(data) {
