...
$query = "SELECT * FROM lots ORDER BY id desc limit 1 ";
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">New Listing for Lots</h4>
                                </div>

                                <!-- ##########################INSERT DATA################################### -->
                                <div class="modal-body">
                                    <form action="lotsbackend.php" method="POST" enctype="multipart/form-data">
                                    <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="description" placeholder="Description here..." id="description" class="form-control" required></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col text-center">
                                            ...
                                            <button type="submit" class="btn btn-success" id="lots-save-btn" name="lots-save-btn">Save</button>
                                        </div>
                                    </form>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <button class="btn btn-primary btn-lg fa fa-plus " data-toggle="modal" data-target="#lotsModal"> Add Property</button>
                                        <?php

                                        $query = "SELECT id,property_name,locations,price,status FROM lots ORDER BY id desc";
     ...
     <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.deletebutton', function() {
                var lots_delete_property_id = $(this).attr("id");
                $.ajax({
                    url: "lotsbackend.php",
                    method: "POST",
                    data: {
                        lots_delete_property_id: lots_delete_property_id
                    },
                    success: function(data) {
