...
$query = "SELECT * FROM commercials ORDER BY id desc limit 1 ";
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    ...
                    <h1 class="Page-header ">Commercial Property</h1>

                    <div class="modal fade" id="commercialsModal">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                    <h4 class="modal-title" id="myModalLabel">New Listing for Commercial Property</h4>
                                </div>

                                <!-- ##########################INSERT DATA################################### -->
                                <div class="modal-body">
                                    <form action="commercialsbackend.php" method="POST" enctype="multipart/form-data">
                                        <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="description" id="description" placeholder="Description here..." class="form-control" required></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col text-center">
                                            ...
                                            <button type="submit" class="btn btn-success" id="commercials-save-btn" name="commercials-save-btn">Save</button>
                                        </div>
                                    </form>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <button class="btn btn-primary btn-lg fa fa-plus " data-toggle="modal" data-target="#commercialsModal"> Add Property</button>
                                        <?php

                                        $query = "SELECT id,developer,property_name,locations,status FROM commercials ORDER BY id desc";
     ...
     <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.editbutton', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#ccommercials-save-btn').val("Update");
            ...
            $(document).on('click', '.deletebutton', function() {
                var commercials_delete_property_id = $(this).attr("id");
                $.ajax({
                    url: "commercialsbackend.php",
                    method: "POST",
                    data: {
                        commercials_delete_property_id: commercials_delete_property_id
                    },
                    success: function(data) {
