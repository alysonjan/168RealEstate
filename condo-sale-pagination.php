...
$sql = "SELECT h.id,hmi.main_image, h.developer, h.property_name, h.locations, h.units, h.price, h.reservationfee,h.monthlyprice,
               h.status FROM condominiums as h, condominiums_main_image as hmi
               WHERE h.main_image_id = hmi.image_id AND h.status ='sale' ORDER BY h.id desc LIMIT $start_from, $record_per_page ";
      ...
      <div class="card shadow border-secondary">
        ...
        <div class="card-body">
          ...
          <p>
            ...
            Estimated Monthly Equity : <?= $row['monthlyprice']; ?><br>
          </p>
...
$page_query =
  "SELECT h.id,hmi.main_image, h.developer, h.property_name, h.locations, h.units, h.price, h.reservationfee,h.monthlyprice,
              h.status FROM condominiums as h, condominiums_main_image as hmi
              WHERE h.main_image_id = hmi.image_id AND h.status ='sale' ORDER BY h.id desc ";
