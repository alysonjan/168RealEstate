          ...
          <div class="sticky" style="position: sticky; position: -webkit-sticky; top:0; ">
            ...
            <div class="bg-light border-right" id="sidebar-wrapper">
              <div class="list-group list-group-flush">
                <a href="house-rent.php" class="list-group-item list-group-item-action bg-primary active" id="house">House &amp; Lot</a>
                <a href="condo-rent.php" class="list-group-item list-group-item-action bg-light " id="condominiums">Condominiums</a>
                <a href="commercial-rent.php" class="list-group-item list-group-item-action bg-light " id="commercial">Commercial Property</a>
                <a href="lots-rent.php" class="list-group-item list-group-item-action bg-light " id="lots">Lot Only</a>
