          ...
          <div class="sticky" style="position: sticky; position: -webkit-sticky; top:0; ">
            ...
            <div class="bg-light border-right" id="sidebar-wrapper">
              <div class="list-group list-group-flush">
                ...
                <a href="commercial-rent.php" class="list-group-item list-group-item-action active " id="commercial">Commercial Property</a>
                <a href="lots-rent.php" class="list-group-item list-group-item-action " id="lots">Lot Only</a>
...
$(document).ready(function(){
    ...
    function load_data(page){
        $.ajax({
            url:"commercial-rent-pagination.php",
            method:"POST",
            data:{page:page},
